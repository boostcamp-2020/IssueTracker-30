...
const StyledLabelButton = styled(Link)`
    display: flex;
    flex-direction: rows;
...
const StyledMilestoneButton = styled(Link)`
    display: flex;
    flex-direction: rows;
    justify-content: center;
    align-items: center;
    ...
    return (
        <StyledButtons>
            <StyledLabelButton to="/labels">
                ...
                <StyledLabelMilestoneText>Labels</StyledLabelMilestoneText>
            ...
            <StyledMilestoneButton to="/">
                ...
                <StyledLabelMilestoneText>Milestones</StyledLabelMilestoneText>
                <StyledLabelMilestoneNumber>
                    {milestoneCount}
                </StyledLabelMilestoneNumber>
